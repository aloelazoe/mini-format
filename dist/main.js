(function () {
  ...
  function main() {
    var storyDataElm = document.getElementsByTagName('tw-storydata')[0];

    var passageElms = _toConsumableArray(document.getElementsByTagName('tw-passagedata'));

    var tagElms = _toConsumableArray(document.getElementsByTagName('tw-tag'));
    ...
    tagElms.forEach(function (tagElm) {
      data.tags.push(tagElm.getAttribute('name')); // they also have color attribute which seems useless outside of the editor
    });
